...
<div class="about-intro">
  <div class="about-avatar">
    <img src="../../assets/images/my-image.png" alt="陈君">
  </div>
  <div class="about-text">
    <p>自2007年毕业后，做企业级软件 19 年了，最近几年一直在做一件事——<strong>把 AI 从演示环境跑进生产系统</strong>。</p>
    <p>不是在 PPT 里，是在中大型企业的业务系统里、在工业互联网的核心链路上、在每天有人真正在用的运维工具里。</p>
    <p>如果你正好也在做（或想做）类似的事，希望我的经历对你有帮助。</p>
  </div>
</div>
